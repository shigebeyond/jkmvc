 ...
 * orm的元数据
 */
data class MetaData(public val clazz:Class<*> /* 模型类 */, public val dbName:String = "database" /* 数据库名 */, public var table:String = "" /* 表名 */, public val primaryKey:String = "id" /* 主键 */, public val relations:Map<String, MetaRelation>? = null /* 关联关系 */ ){
    init {
