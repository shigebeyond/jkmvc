...
class ModelGeneratorTests{
    ...
    @Test
    fun testCodeModel() {
        val generator = ModelGenerator("/oldhome/shi/code/java/jkerp/core/src/main/kotlin/net/jkcode/jkerp/app", "net.jkcode.jkerp.app", "default", "shijianhang")
...
//        generator.genenateModelFile("BenchmarkResultModel", "性能测试结果", "benchmark_result")
        ...
        generator.genenateModelFile("ReportWorkflowProcessInstance", "", "app_report_process_instance")
        ...
        generator.genenateModelFile("WorkflowProcessLink", "", "wf_process_link")
